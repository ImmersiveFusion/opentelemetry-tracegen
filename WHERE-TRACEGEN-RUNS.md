...
- **Where it runs:** the **Immersive Fusion cloud**: seven always-on workloads on Kubernetes, with deployments managed declaratively via GitOps (Argo CD).
